...
//Any comment that starts as Uppercase, is a personal (or peer-to-peer) comment
//Any comment that starts as lowercase, is a programming comment 

//Any questions regarding how to use a design program for chars and tiles,
//Please email me at carpenterjasonb@gmail.com

//Breaking Bits / Breaking Bad for NES / Methamphet8bit
//Note to self, pick a name.

//include the library

#include "neslib.h"

//Here are the nametables, you don't have to mess with these.
//If you decide to, please make a back up before doing so.
...
//I ripped off these sounds, but I found a program called famitone to make new ones.
...
const unsigned char palTitle[16]={ 0x11,0x09,0x30,0x16,0x11,0x37,0x0f,0x30,0x11,0x12,0x22,0x32,0x11,0x14,0x24,0x34 };
...
const unsigned char statsStr[27]={
	0x2c,0x25,0x36,0x25,0x2c,0x1a,0x00,0x00,0x33,
	0x35,0x24,0x2f,0x1a,0x00,0x00,0x00,0x0f,0x00,
